...
module.exports = {
  ...
  menu: process.env.MENU || "Gifted_Md", /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_Md, 3: Panther-Md Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/
